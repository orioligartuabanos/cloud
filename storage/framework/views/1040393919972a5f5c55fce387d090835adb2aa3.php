...
<div>
            <form method="post" action="<?php echo e(route('llibre_cerca')); ?>" >
                <?php echo csrf_field(); ?>
...
<br>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/M7_1/M7_Pt3b_IgartuaBanos_Oriol/resources/views/llibre/list.blade.php ENDPATH**/ ?>